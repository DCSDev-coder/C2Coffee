...
class Signup2Backup extends StatefulWidget {
  ...
  @override
  State<Signup2Backup> createState() => _Signup2BackupState();
}

class _Signup2BackupState extends State<Signup2Backup> {
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const LoginBackup()),
                              );
                            },
                            child: RichText(
                              text: const TextSpan(
