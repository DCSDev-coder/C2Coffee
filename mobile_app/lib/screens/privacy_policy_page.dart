              ...
              children: [
                ...
                _buildSection(
                  ...
                  body:
                      ...
                      '• Contact & Authentication Data: Malaysian mobile telephone number, WhatsApp One-Time Password (OTP) records, and SMS OTP verification logs.\n\n'
                      ...
                      '• Payment Card Notice: We do NOT collect, process, or store credit/debit card numbers (PAN) or CVV codes. All payment entries are handled securely on Billplz-hosted gateway rails.\n\n'
                ...
                _buildSection(
                  ...
                  body:
                      ...
                      '• Authenticating your login sessions via WhatsApp or SMS OTP.\n\n'
                ...
                _buildSection(
                  ...
                  body:
                      ...
                      '• Payment Gateway: Billplz (processing FPX banking, Touch \'n Go eWallet, and card payments).\n\n'
                      '• OTP & Messaging Services: Meta WhatsApp Cloud API and authorized Malaysian telecommunication SMS gateways.\n\n'
